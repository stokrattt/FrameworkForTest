...
describe('Protractor Demo App', function () {
	...
	it('creating Client', function () {
		...
		browser.sleep(2000);
		element(by.xpath('//select[@ng-options="service.id as service.title for service in services"]/option[2]')).click();//�������� Moving & Storage
		browser.sleep(2000);
	...
	it('ProRating', function () {
		...
		browser.sleep(4000);
		//������� ��������� ��� � ������
		var days1 = new Date(future.getFullYear(), future.getMonth() + 1, 0).getDate();//���������� ���� � ������ ������ ��������
